...
router.post('/content/banner', upload.single('image'), addBanner);
router.delete('/content/banner/:bannerId', deleteBanner);
router.put('/content/stats', updateStats);
router.put('/content/contact', updateContactInfo);
router.post('/content/vacancies', addVacancy);
router.put('/content/vacancies/:vacancyId', updateVacancy);
